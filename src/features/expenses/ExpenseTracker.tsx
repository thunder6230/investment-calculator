...
export default function ExpenseTracker() {
  ...
  return (
    <section className="card">
      <h2 className="section-title">🛒 Expense &amp; Budget Setup</h2>
      ...
      {expenseMode === 'simple' ? (
        ...
        <div className="expense-tracker-section" style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          {/* Expense Items List */}
          <div className="expense-items-list" style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', maxHeight: '200px', overflowY: 'auto', paddingRight: '2px' }}>
